...
import { upsertMealPlanWork, getMealPlanWork, getMealPlanWorkById } from './mealPlanWork.controller';
 ...
 */
router.get('/:id', auth('admin'), getMealPlanWorkById);

export const mealPlanWorkRouter = router;
