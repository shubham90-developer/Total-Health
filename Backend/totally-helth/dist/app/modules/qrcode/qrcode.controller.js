...
exports.bookTableByScan =
  exports.deleteQRCodeById =
  exports.updateQRCodeById =
  exports.getQRCodeById =
  exports.getAllQRCodes =
...
const uploadToCloudinary = (dataUrl, tableNumber, hotelName) =>
...
const generateQRCodeWithLogo = (data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (
        ...
        const vendorHotelId =
          (_b = req.user.vendorDetails) === null || _b === void 0
            ? void 0
            : _b.hotel;
        if (!vendorHotelId || vendorHotelId.toString() !== hotelId) {
          return next(
            new appError_1.appError(
              "You can only create QR codes for your own hotel.",
              403,
            ),
          );
        }
      ...
      const frontendUrl =
        process.env.FRONTEND_URL || "https://http://localhost:8080";
      ...
      const imageUrl = yield uploadToCloudinary(
        qrCodeDataURL,
...
const getAllQRCodes = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
      ...
      if (
        ...
        const userHotelId =
          (_c = req.user.vendorDetails) === null || _c === void 0
            ? void 0
            : _c.hotel;
        if (userHotelId) {
        ...
        ((_d = req.user) === null || _d === void 0 ? void 0 : _d.role) ===
          "admin" &&
        hotelId
      ) {
...
const getQRCodeById = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateQRCodeById = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const newImageUrl = yield uploadToCloudinary(
        newQrCodeDataURL,
        validatedData.tableNumber,
        hotel.name,
      );
...
const deleteQRCodeById = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const qrCode = yield qrcode_model_1.QRCode.findOneAndUpdate(
      ...
      if (!qrCode) {
        return next(
          new appError_1.appError("QR Code not found or already deleted", 404),
        );
      }
      res.json({
        success: true,
...
const bookTableByScan = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { hotelId, tableNumber } =
        qrcode_validation_1.bookTableValidation.parse(req.body);
      const table = yield qrcode_model_1.QRCode.findOneAndUpdate(
      ...
      if (!table) {
        return next(
          new appError_1.appError("Table not found for this hotel", 404),
        );
      }
      res.json({
        success: true,
