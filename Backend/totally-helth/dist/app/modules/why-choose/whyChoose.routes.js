...
exports.whyChooseRouter = void 0;
const express_1 = __importDefault(require("express"));
const authMiddleware_1 = require("../../middlewares/authMiddleware");
const whyChoose_controller_1 = require("./whyChoose.controller");
 ...
 */
router.get('/:id', whyChoose_controller_1.getWhyChooseById);
exports.whyChooseRouter = router;
