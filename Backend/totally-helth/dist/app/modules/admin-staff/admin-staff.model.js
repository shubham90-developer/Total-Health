...
exports.AdminStaff = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const bcrypt_1 = __importDefault(require("bcrypt"));
const adminStaffSchema = new mongoose_1.Schema({
...
adminStaffSchema.methods.comparePassword = function (password) {
    return __awaiter(this, void 0, void 0, function* () {
        return bcrypt_1.default.compare(password, this.password);
    });
};
exports.AdminStaff = mongoose_1.default.model('AdminStaff', adminStaffSchema);
