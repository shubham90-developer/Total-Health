...
exports.globalAccessControl = void 0;
...
const hasAccess = (userMenuAccess, requiredPermission) => {
    var _a, _b, _c, _d, _e;
    if (!userMenuAccess || !requiredPermission)
        return false;
    const parts = requiredPermission.split('.');
    if (parts.length === 1) {
        // Top level permission like 'dashboard', 'more-options', 'faqs', etc.
        const moduleKey = parts[0];
        return ((_a = userMenuAccess[moduleKey]) === null || _a === void 0 ? void 0 : _a.checked) === true;
    }
    else if (parts.length === 2) {
        // Nested permission like 'sales.sales-list'
        const [parent, child] = parts;
        // Check if parent module is checked
        if (!((_b = userMenuAccess[parent]) === null || _b === void 0 ? void 0 : _b.checked)) {
            return false;
        }
        // Check if user has direct permission
        if (((_d = (_c = userMenuAccess[parent]) === null || _c === void 0 ? void 0 : _c.children) === null || _d === void 0 ? void 0 : _d[child]) === true) {
            return true;
        }
        // If user has any list access in this module, grant edit/delete access
        const hasListAccess = Object.keys(((_e = userMenuAccess[parent]) === null || _e === void 0 ? void 0 : _e.children) || {})
            .some(key => { var _a, _b; return (key.includes('list') || key.includes('List')) && ((_b = (_a = userMenuAccess[parent]) === null || _a === void 0 ? void 0 : _a.children) === null || _b === void 0 ? void 0 : _b[key]) === true; });
        if (hasListAccess) {
...
const globalAccessControl = () => {
    return (req, res, next) => {
        ...
        try {
            ...
            fullPath = req.baseUrl + (((_a = req.route) === null || _a === void 0 ? void 0 : _a.path) || req.path);
...
exports.globalAccessControl = globalAccessControl;
