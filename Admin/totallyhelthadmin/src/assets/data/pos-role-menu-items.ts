    ...
    children: [
      {
        key: 'benefits',
        label: 'Benefits',
        url: '/pages/healthPartner/benifits',
        parentKey: 'health-partner',
      },
      {
        key: 'partner-in-health',
        label: 'Partner In Health',
        url: '/pages/healthPartner/partnerInHealth',
        parentKey: 'health-partner',
      },
    ],
  },
