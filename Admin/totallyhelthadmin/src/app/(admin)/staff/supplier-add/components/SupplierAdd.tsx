...
const GeneralInformationCard: React.FC<ControlType> = ({ control }) => {
  return (
    <Card>
      <CardHeader>
        <CardTitle as={'h4'}>Supplier - Add</CardTitle>
      </CardHeader>
      <CardBody>
        <Row>
          <Col lg={6}>
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} name="address" label="Product Categories" />
            </div>
          </Col>

          <Col lg={4}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="dateOfJoining" label="TRN" />
            </div>
          </Col>
