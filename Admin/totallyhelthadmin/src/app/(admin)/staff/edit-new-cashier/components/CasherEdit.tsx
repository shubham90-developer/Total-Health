...
const GeneralInformationCard: React.FC<ControlType> = ({ control }) => {
  return (
    <Card>
      <CardHeader>
        <CardTitle as={'h4'}>Casher Master - Add</CardTitle>
      </CardHeader>
      <CardBody>
        <Row>
          <Col lg={4}>
            <div className="mb-3">
              <TextFormInput control={control} name="waiterId" label="Casher ID" />
            </div>
          </Col>
          <Col lg={4}>
            <div className="mb-3">
