        ...
        <Col xl={12}>
          <Card>
            <CardHeader className="d-flex flex-wrap justify-content-between align-items-center gap-2">
              ...
              <Link href="/staff/add-new-cashier" className="btn btn-lg btn-primary">
                + Add Casher
              </Link>
            </CardHeader>
                ...
                <table className="table align-middle mb-0 table-hover table-centered table-bordered">
                  <thead className="bg-light-subtle">
                    <tr>
                      ...
                      <th style={{ textWrap: 'nowrap' }}>Casher ID / Employee Code</th>
                      <th style={{ textWrap: 'nowrap' }}>Casher Name</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ textWrap: 'nowrap' }}>Cas#001</td> {/* Waiter ID */}
                      ...
                      <td style={{ textWrap: 'nowrap' }}>
                        <div className="d-flex gap-2">
                          <Link href="/staff/edit-new-cashier" className="btn btn-soft-primary btn-sm">
