                ...
                <table className="table align-middle mb-0 table-hover table-centered table-bordered">
                  <thead className="bg-light-subtle">
                    <tr>
                      ...
                      <th style={{ textWrap: 'nowrap' }}>Plan Start Date</th>
                      <th style={{ textWrap: 'nowrap' }}>Plan End Date</th>
                      <th style={{ textWrap: 'nowrap' }}>Due Date</th>
                      <th style={{ textWrap: 'nowrap' }}>Overdue Days</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ textWrap: 'nowrap' }}>02 Nov 2025</td>
                      <td style={{ textWrap: 'nowrap' }}>02 Nov 2025</td>
                      <td style={{ textWrap: 'nowrap' }}>
                        <span className="badge bg-success">20 Days</span>
                      </td>
                      <td style={{ textWrap: 'nowrap' }}>
                        <span className="badge bg-success">Unpaid</span>
                      </td>
