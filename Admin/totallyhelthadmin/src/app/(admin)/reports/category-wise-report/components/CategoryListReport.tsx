                ...
                <table className="table align-middle mb-0 table-hover table-centered table-bordered">
                  <thead className="bg-light-subtle">
                    <tr>
                      ...
                      <th style={{ textWrap: 'nowrap' }}>Select Meal Plan Category</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ textWrap: 'nowrap' }}>
                        <span className="badge bg-success">International Meal Plan</span>
                      </td>
...
export default CategoryListReport
