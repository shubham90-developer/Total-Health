        ...
        <Col xl={12}>
          <Card>
            <div className="d-flex card-header justify-content-between align-items-center">
              <div>
                <CardTitle as={'h4'}>Meal Plan Order History </CardTitle>
              </div>
                ...
                <table className="table align-middle mb-0 table-hover table-centered table-bordered">
                  <thead className="bg-light-subtle">
                    <tr>
                      ...
                      <th style={{ textWrap: 'nowrap' }}>Calories per day</th>
                      <th style={{ textWrap: 'nowrap' }}>Days per week</th>
                      <th style={{ textWrap: 'nowrap' }}>How many weeks</th>
                      <th style={{ textWrap: 'nowrap' }}>Paid Status</th>
                      <th style={{ textWrap: 'nowrap' }}>Payment Mode</th>
                      <th style={{ textWrap: 'nowrap' }}>Order Mode</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ textWrap: 'nowrap' }}>1,000-1400</td>
                      <td style={{ textWrap: 'nowrap' }}>5 Days</td>
                      <td style={{ textWrap: 'nowrap' }}>4 Weeks</td>
                      <td style={{ textWrap: 'nowrap' }}>
                        <span className="badge bg-success">Paid</span>
                      </td>
                      <td style={{ textWrap: 'nowrap' }}>Online</td>
                      <td style={{ textWrap: 'nowrap' }}>
                        <span className="badge bg-success">Website</span>
                      </td>
                      <td>
                        <div className="d-flex gap-2">
                          <Button variant="danger" size="sm" onClick={() => setShowOrderHistory(true)}>
                            <IconifyIcon icon="solar:pause-broken" className="align-middle fs-18" />
                          </Button>
...
export default MenuPlanOrderList
